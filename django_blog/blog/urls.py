...
from .views import UserLoginView, RegisterView, PostListView, CommentUpdateView, CommentDeleteView, CommentCreateView
...
urlpatterns = [
    ...
    path('comment/<int:pk>/new/', CommentCreateView.as_view(), name='comment_update'),
