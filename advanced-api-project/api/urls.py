...
urlpatterns = [
    ...
    path('books/<int:pk>/update/', BookUpdateView.as_view(), name='book_update') #path to update a specific book
    path('books/<int:pk>/delete/', BookDeleteView.as_view(), name='book_delete')#path to delete a specific book
